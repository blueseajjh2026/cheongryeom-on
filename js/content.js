window.CHEONGRYEOM_CONTENT={
  virtues:[
    {key:'honesty',name:'정직',tag:'진실을 위한',desc:'업무 사실·진행상황을 숨기거나 꾸미지 않고 정확하게 보고하는 태도'},
    {key:'promise',name:'약속',tag:'함께 지키는',desc:'근무시간·납기·안전수칙 등 직장에서 정한 약속과 규정을 지키는 태도'},
    {key:'care',name:'배려',tag:'공공(모두)을 위한',desc:'동료·고객·협력업체 등 다양한 관계자의 입장과 공공의 이익을 고려하는 태도'},
    {key:'responsibility',name:'책임',tag:'내 몫을 다하는',desc:'맡은 직무를 끝까지 수행하고 문제 발생 시 보고·조치·결과까지 책임지는 태도'},
    {key:'restraint',name:'절제',tag:'욕심을 조절하는',desc:'회사 자산과 사적 이익을 구분하고 선물·편의·개인적 욕심을 조절하는 태도'},
    {key:'fairness',name:'공정',tag:'치우치지 않는',desc:'학연·친분보다 공개되고 합리적인 직무기준을 동일하게 적용하는 태도'}
  ],
  stages:[
    ...
    {key:'team',name:'직무상황 종합평가',short:'종합'},
    {key:'diagnosis',name:'역량진단',short:'진단'},
    {key:'pledge',name:'직업윤리 실천',short:'실천'},
    {key:'result',name:'자격판정',short:'결과'}
  ],
  intro:{
    title:'직업윤리는 아는 것에서 끝나지 않습니다. 실제 업무를 처리하는 과정에서 역량이 드러납니다.',
    body:'필기에서는 예비 직업인이 알아야 할 청렴·직업윤리 기준을 확인하고, 개인 직무형 실기에서는 구매·정산·선발 자료를 직접 처리합니다. 마지막 직무상황 종합평가에서는 동료마다 다른 업무정보를 공유하고 돌발상황에 대응해 하나의 의사결정 보고서를 완성합니다.'
  },
  written:[
    {id:'w1',virtue:'honesty',q:'현장실습 중 생성형 AI로 업무보고서 초안을 만들었습니다. 가장 정직한 제출 방식에 가까운 것은?',options:['AI가 만든 내용을 거의 그대로 제출한다.','AI를 사용했다는 사실은 굳이 말하지 않는다.','회사·실습 지침을 확인하고, 사용 범위를 밝힌 뒤 실제 사실과 내 검토를 거쳐 다시 작성한다.','문장 몇 개만 바꾸면 내가 쓴 글과 같으므로 그대로 제출한다.'],correct:2,ex:'도구를 사용하는 것 자체보다 사용 사실과 범위를 숨기고 결과물을 자신의 성과처럼 제시하는지가 핵심입니다.',impact:{honesty:100,responsibility:55}},
    {id:'w2',virtue:'promise',q:'팀 업무회의 시간에 개인 일정이 겹겼습니다. 가장 적절한 행동은?',options:['아무 말 없이 참석하지 않는다.','친한 친구에게만 개인적으로 말한다.','가능한 빨리 팀에 알리고 업무에 지장이 없도록 일정·대안을 함께 조정한다.','회의가 중요하지 않다고 생각되면 나중에 자료만 받는다.'],correct:2,ex:'약속은 시간을 지키는 것뿐 아니라 지키기 어려운 상황이 생겼을 때 상대방에게 미리 알리고 함께 조정하는 책임까지 포함합니다.',impact:{promise:100,responsibility:55}},
    {id:'w3',virtue:'care',q:'현장실습 팀 회의에서 한 동료가 익숙하지 않아 의견을 내지 못하고 있습니다. 직업윤리적 배려에 가장 가까운 행동은?',options:['시간이 부족하므로 발표를 잘하는 친구들끼리 결정한다.','그 친구의 의견을 대신 추측해서 반영한다.','발언 기회를 만들고 충분히 듣고 난 뒤, 팀 전체가 함께 결정한다.','친한 친구가 원하면 그 친구에게 발언 시간을 더 준다.'],correct:2,ex:'배려는 특정 사람만 편들어 주는 것이 아니라 모두가 참여할 수 있도록 조건을 만들어 공동의 이익을 고려하는 태도입니다.',impact:{care:100,fairness:45}},
    {id:'w4',virtue:'responsibility',q:'내가 맡은 업무가 예상보다 늦어져 납기에 차질이 생길 것 같습니다. 가장 책임 있는 행동은?',options:['문제가 커지기 전까지 말하지 않는다.','지연 사실과 현재 진행상황을 즉시 보고하고, 완료계획이나 대안을 제시한다.','인터넷 글을 그대로 복사해 빨리 끝낸다.','다른 친구가 대신 해결하도록 기다린다.'],correct:1,ex:'책임은 맡은 일을 하는 것뿐 아니라 문제가 생겼을 때 숨기지 않고 해결 과정과 결과까지 감당하는 태도입니다.',impact:{responsibility:100,honesty:60}},
    {id:'w5',virtue:'restraint',q:'현장실습 부서에서 구매한 소모품이 남았습니다. 개인적으로 갖고 싶은 물품이 하나 있습니다. 가장 적절한 행동은?',options:['금액이 작다면 가져가도 된다.','행사에 많이 기여했으니 보상으로 가져간다.','회사 자산 처리기준을 확인하고 승인된 방식으로 처리한다.','친구들이 괜찮다고 하면 가져간다.'],correct:2,ex:'절제는 내 것과 공동의 것을 구분하고, 개인의 욕심보다 정해진 기준을 따르는 태도와 연결됩니다.',impact:{restraint:100,responsibility:50}},
    {id:'w6',virtue:'fairness',q:'프로젝트 참여자를 선발하는데 지원자 중 친한 선배의 동생이 있습니다. 가장 공정한 선발 방식은?',options:['친구가 평소 좋은 사람이므로 높은 점수를 준다.','평가기준을 사전에 정하고 모든 지원자에게 같은 기준을 적용한다.','친구는 오해를 살 수 있으니 무조건 낮은 점수를 준다.','모두 똑같이 대우하기 위해 지원 내용을 보지 않고 추첨한다.'],correct:1,ex:'공정은 친분의 영향을 배제하는 동시에, 합리적이고 공개된 기준을 일관되게 적용하는 것을 의미합니다.',impact:{fairness:100,honesty:40}}
  ],
  practical:[
    {
      id:'p1',kind:'procurement',title:'직무형 제1과제 · 공정한 구매업무',code:'P-01',timeLimitSec:300,
      objective:'지급자료를 검토하고 이해관계를 확인한 뒤, 공정한 기준에 따라 구매계획을 완성하십시오.',
      context:'현장실습 중 부서 소모품 구매업무를 맡은 신입 실습생입니다. 사용 가능한 예산은 300,000원이며, 세 업체의 견적과 회사 구매기준이 지급되었습니다.',
      deliverables:['지급자료 확인','이해관계 확인','비교기준 설정','업체 선정','처리방식 및 선정사유 기록'],
      docs:[
        {id:'rule',icon:'📘',title:'자료 1 · 회사 구매업무 기준',body:'① 필요한 물품을 예산 범위 안에서 구매합니다. ② 가격만이 아니라 품질·납기 등 합리적인 기준을 함께 비교할 수 있습니다. ③ 담당자와 개인적 이해관계가 있는 업체가 있으면 그 사실을 공개하고 동일한 기준으로 검토해야 합니다. ④ 선정 과정과 사유를 기록으로 남깁니다.'},
        ...
        {id:'C',icon:'📄',title:'자료 4 · 우리문구 견적서',body:'총액 262,000원 · 품질 5/5 · 배송: 당일 · 미개봉 반품 가능 · 실습 지도자의 지인이 운영 · 개인용 사은품 제공 제안'}
      ],
      criteria:[
    ...
    {
      id:'p2',kind:'sequence',title:'직무형 제2과제 · 법인카드 증빙누락 처리',code:'P-02',timeLimitSec:300,
      objective:'정산자료와 메시지를 확인하고, 증빙이 누락된 지출을 투명하게 처리하는 절차를 순서대로 완성하십시오.',
      context:'현장실습 부서의 법인카드 사용내역을 정리하던 중 소모품 47,000원의 영수증이 누락됐습니다. 선배가 “다른 영수증에 조금 섞어서 맞추면 돼.”라고 말했습니다.',
      ledger:[
        {item:'장식품',amount:'82,000원',proof:true},{item:'음료',amount:'56,000원',proof:true},{item:'소모품',amount:'47,000원',proof:false},{item:'인쇄비',amount:'38,000원',proof:true}
      ],
      actions:[
    ...
    {
      id:'p3',kind:'panel',title:'직무형 제3과제 · 공정한 인턴 선발',code:'P-03',timeLimitSec:420,
      objective:'공개된 평가표에 따라 지원자를 직접 채점한 뒤, 추가로 알게 된 친분 관계에도 동일한 기준을 유지할 수 있는지 판단하십시오.',
      context:'프로젝트 인턴 1명을 선발하는 평가위원 역할을 맡았습니다. 지원자의 이름은 가리고 A·B·C로 표시했습니다. 공개된 직무기준으로 먼저 채점한 뒤 추가정보를 확인합니다.',
      rubricFields:[
        {key:'plan',label:'직무계획',max:40},{key:'responsibility',label:'책임감',max:30},{key:'collaboration',label:'협업경험',max:20},{key:'presentation',label:'발표내용',max:10}
      ],
      candidates:[
        {id:'A',name:'지원자 A',profile:'직무계획에 일정·예산이 구체적으로 제시됨. 프로젝트 총무 경험 2회. 협업 프로젝트 2회.',speech:'저는 행사 준비를 일정표와 예산표로 나누어 공개하고, 매주 진행상황을 친구들과 공유하겠습니다. 문제가 생기면 역할을 다시 조정해 끝까지 책임지겠습니다.',reference:{plan:35,responsibility:27,collaboration:16,presentation:8}},
        ...
        {id:'C',name:'지원자 C',profile:'직무계획이 구체적이고 안전대책을 포함함. 프로젝트 책임자 경험 2회. 협업 프로젝트 2회.',speech:'행사 전에 안전점검표와 역할표를 만들고, 준비가 늦어질 때를 대비한 대체안도 마련하겠습니다. 정한 기준은 모든 학생에게 똑같이 적용하겠습니다.',reference:{plan:36,responsibility:29,collaboration:17,presentation:8}}
      ],
      extraInfo:'추가정보: 지원자 C는 같은 학교 선배의 동생입니다.',
      responses:[
        '관계를 공개하고, 이미 정한 직무평가기준과 점수를 그대로 유지한다.',
  ...
  team:{
    id:'t1',code:'T-01',title:'직무상황 종합평가 · 신입사원 구매회의',timeLimitSec:720,
    objective:'부서원마다 서로 다른 업무정보를 공유하고, 공정한 구매기준을 세운 뒤 돌발상황까지 반영하여 하나의 최종 의사결정 보고서를 완성하십시오.',
    context:'현장실습 중 부서에서 고객행사용 작업키트 200개를 긴급 구매해야 합니다. 예산·거래처·납기·이해관계 정보가 서로 다른 부서원에게 나누어 지급됩니다. 혼자서는 전체 업무조건을 알 수 없으므로 반드시 정보를 공유해야 합니다.',
    roleOrder:['records','finance','purchase','operations','verify'],
    roles:{
      records:{key:'records',name:'서기(기록·조정)',icon:'🗂️',secret:'회사 구매규정에는 개인적 이해관계가 있는 업체가 있으면 관계를 공개하고, 같은 기준으로 공동심의하며 선정사유를 기록하도록 되어 있습니다. 또한 B업체 대표는 팀장의 친인척입니다.',options:['B업체와의 이해관계를 공개하고 동일 기준으로 심의·기록해야 한다.','친척 업체는 이유를 따지지 않고 무조건 탈락시켜야 한다.','친척 관계는 가격과 무관하므로 팀에 알릴 필요가 없다.'],correct:0,keywords:['이해관계','공개','기준','기록']},
      ...
      operations:{key:'operations',name:'행사 운영 담당',icon:'⏰',secret:'고객행사는 내일 10:00에 시작하고, 사전 검수 때문에 작업키트는 늦어도 09:30까지 현장에 도착해야 합니다. 09:30 이후 도착하는 물품은 사용할 수 없습니다.',options:['09:30 이전 납품 가능 여부는 필수 기준이다.','행사는 10시에 시작하므로 10시까지 오면 된다.','조금 늦어도 가격이 싸면 기다릴 수 있다.'],correct:0,keywords:['09:30','납품','시간','필수']},
      verify:{key:'verify',name:'검증 담당',icon:'🔎',secret:'공정한 구매에서는 사은품, 개인적 친분, 인기 같은 사적 요소를 평가기준으로 삼지 않습니다. 판단에 사용한 기준과 변경사유는 나중에 확인할 수 있도록 기록해야 합니다.',options:['사적 요소는 배제하고 객관적 기준과 변경사유를 기록해야 한다.','사은품이 많으면 회사에도 이익이므로 중요한 기준이다.','팀원 다수가 좋아하는 업체를 선택하면 공정하다.'],correct:0,keywords:['사적','객관','기준','기록']}
    },
    supplemental:{
      purchase:'보완 지급자료 · 구매정보: A 215,000원/오늘 17:00/품질4, B 208,000원/내일 09:00/품질5, C 198,000원/내일 11:30/품질4.',
      operations:'보완 지급자료 · 업무정보: 고객행사는 내일 10:00 시작, 사전 검수 때문에 09:30까지 납품 완료가 필수입니다.',
    ...
    issues:[
      ...
      {key:'conflict',label:'B업체와 팀장과의 이해관계 확인',good:true},
      {key:'record',label:'기준·선정사유 기록 의무 확인',good:true},
      {key:'popularity',label:'동료들이 선호하는 업체 확인',good:false},
